...
if __name__ == '__main__':
    ...
    # 1.2. Paths
    parser.add_argument('-dataset_path', default='/misc/scratch11/6th-ABAW_Competition_2024/6th-ABAW_Competition_23Feb2024/ABAW6_48', type=str,
                        help='The root directory of the preprocessed dataset.')  # /scratch/users/ntu/su012/dataset/mahnob
    parser.add_argument('-load_path', default='/misc/scratch11/6th-ABAW_Competition_2024/6th-ABAW_Competition_23Feb2024/pretrained_model', type=str,
                        help='The path to load the trained models, such as the backbone.')  # /scratch/users/ntu/su012/pretrained_model
    parser.add_argument('-save_path', default='/misc/scratch11/6th-ABAW_Competition_2024/6th-ABAW_Competition_23Feb2024/save', type=str,
    ...
    parser.add_argument('-stamp', default='RCMA_setup_new_TCN_512', type=str, help='To indicate different experiment instances')
    ...
    parser.add_argument('-modality', default=['video', 'logmel', "bert", "VA_continuous_label"], nargs="*")
